# Тебе нужно создать класс, который подсчитывает результаты состязаний — **Results.** И двух его наследников — Football и Hockey. 
...
class Football(Results):
    ...
    def total_points(self):
        self.total = 3 * self.victories + self.draws
        return f'Общее количество очков: {self.total}'
...
class Hockey(Results):
    ...
    def total_points(self):
        self.total = 2 * self.victories + self.draws
        return f'Общее количество очков: {self.total}'
